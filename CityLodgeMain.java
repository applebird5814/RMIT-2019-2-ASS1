...
public class CityLodgeMain {
    public static void main(String[] args) {
        ...
        //测试部分
        //StandardRoom room1 = new StandardRoom("S_001", "TEKLVISION", 2);
        //hotel.addRoom(room1);
        ...
        for (; i != 7; ) {
                ...
                if (j != 1 && j != 2) {
                    ...
                    if (roomNumber < 0 || roomNumber > 999) {
                        ...
                        if (check != -1) {
                            ...
                            {
                                System.out.println("Feature is too long, it can not be more than 20 litter");
                            }
                            else {
                                //add a standard room
                                if (j == 1) {
            ...
            if (i == 6) {
                System.out.println(hotel.getRoom(0).showAllRecord());
            }
